...
/**
 * Created by Юрий on 18.10.2015 23:10.
 * For ExpListTest.
 */
 ...
 */
    ...
    private final Animation mAnimateToCorrectPosition = new Animation()
    {
        ...
        public void applyTransformation(float interpolatedTime, Transformation t)
        {
            ...
            if (mLayoutMovementEnabled) setTargetOffsetTopAndBottom(offset, false /* requires update */);
    ...
    private Animation.AnimationListener mRefreshListener = new Animation.AnimationListener()
    {
        ...
        public void onAnimationEnd(Animation animation)
        {
            ...
            else
            {
                ...
                {
                    if (mLayoutMovementEnabled) setTargetOffsetTopAndBottom(mOriginalOffsetTop - mCurrentTargetOffsetTop,
    ...
    {
//        Log.i(LOG_TAG, "refreshing: "+refreshing);
        if (refreshing && mRefreshing != refreshing)
        {
            ...
            if (mLayoutMovementEnabled) setTargetOffsetTopAndBottom(endTarget - mCurrentTargetOffsetTop, true /* requires update */);
            mNotify = false;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev)
    {
        ...
        switch (action)
        {
            case MotionEvent.ACTION_DOWN:
                if (mLayoutMovementEnabled) setTargetOffsetTopAndBottom(mOriginalOffsetTop - mCircleView.getTop(), true);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                {
                    Log.v(LOG_TAG, "Got ACTION_MOVE event but don't have an active pointer id.");
                    return false;
                }
        ...
        switch (action)
        {
            ...
            case MotionEvent.ACTION_MOVE:
            {
                ...
                if (mIsBeingDragged)
                {
                    ...
                    if (mLayoutMovementEnabled)  setTargetOffsetTopAndBottom(targetY - mCurrentTargetOffsetTop,
                            true /* requires update */);
                }
                break;
            }
